    ...
    <div id="site_content">
      <div id="content">
        ...
        <div class="page-header">
          <span>DiploVault - Download File</span>
          <h1>File: <em><%=fname%></em></h1>
        </div>
        <div class="download-card">
          <form action="downloads.jsp" method="post">
            <input type="hidden" name="first" value="<%=firstKey%>" />
            <input type="hidden" name="second" value="<%=secondKey%>" />
            <input type="hidden" name="fnamee" value="<%=fname%>" />
            <input type="hidden" name="fid" value="<%=id%>" />
            <span class="file-content-label">Decrypted File Content</span>
