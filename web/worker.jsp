        ...
        <ul id="nav">
          ...
          <li><a href="#">Diplo &#9662;
            <ul>
              ...
              <li class="selected"><a href="worker.jsp">Worker</a></li>
            </ul>
          </a></li>
    ...
    <div id="site_content">
      <div id="content">
        <%
          ...
          ResultSet rt = st.executeQuery("SELECT distinct * FROM `files`,`cluster` where status='yes' and count='yes' AND files.filename = cluster.filename");
        %>
        <div class="page-header">
          <span>DiploVault - Admin Panel</span>
          <h1>Worker Storage with Files Cluster</h1>
        </div>
