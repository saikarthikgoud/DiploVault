  ...
  <div id="main">
    ...
    <header>
      ...
      <nav>
        <ul id="nav">
          ...
          <li class="selected"><a href="cloud_page.jsp">Cloud Home</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
        ...
        <div class="welcome-title">Welcome to <span>Cloud</span></div>
        <div class="welcome-sub">Manage your cloud data efficiently.</div>

<div class="action-cards" style="justify-content:center;gap:24px;">
          <a href="users_1.jsp" class="action-card" style="width:220px;">
          ...
          <a href="files.jsp" class="action-card" style="width:220px;">
            <div class="action-card-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="#0284c7" stroke-width="2"
                   stroke-linecap="round" stroke-linejoin="round">
