    ...
    <div id="site_content">
      <div id="content">
        <%
          ...
          ResultSet rt = st.executeQuery("SELECT distinct * FROM `files` where status='yes' and (original like '%" + key + "%' or filename like '%" + key + "%' or owner_name like '%" + key + "%' );");
        %>
        <div class="page-header">
          <span>DiploVault - Search Results</span>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="download1.jsp?<%=id%>">Download</a></td>
              </tr>
              <%}%>
            </tbody>
          </table>
