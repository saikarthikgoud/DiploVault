    ...
    <header>
      ...
      <nav>
        <ul id="nav">
          ...
          <li class="selected"><a href="filecluster.jsp">File Cluster</a></li>
          <li><a href="#">Diplo &#9662;
            <ul>
    ...
    <div id="site_content">
      <div id="content">
        <%
          ...
          ResultSet rt = st.executeQuery("select * from files where status='No' AND count='No'");
        %>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="file_upl.jsp?<%=rt.getString("filename")%>">Cluster File</a></td>
              </tr>
              <%}%>
            </tbody>
          </table>
