    ...
    <header>
      ...
      <nav>
        <ul id="nav">
          ...
          <li class="selected"><a href="diplo.jsp">Diplo Admin</a></li>
      ...
      <div id="content">
        <div class="login-card">
          ...
          <form action="admin_login" name="ulogin" method="post" onsubmit="return validation()">
            <div class="field-row">
              <label>Diplo ID</label>
              <input type="text" name="username" required placeholder="Enter Diplo ID" />
            </div>
            <div class="field-row">
